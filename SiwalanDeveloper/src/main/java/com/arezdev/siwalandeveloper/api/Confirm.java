...
//RelogCokis
            ...
            //write acc
            try (FileWriter data_cookis = new FileWriter( aku + "\\data\\akun\\akun-" + emulator.split(":")[1] + ".txt"); BufferedWriter br = new BufferedWriter(data_cookis)) {
    ...
    public static void start(String devices) throws URISyntaxException, InterruptedException {
        ...
        try {
            ...
            BufferedReader bfr;
            bfr = new BufferedReader(new FileReader( aku + "\\data\\akun\\akun-" + devices.split(":")[1] + ".txt"));
