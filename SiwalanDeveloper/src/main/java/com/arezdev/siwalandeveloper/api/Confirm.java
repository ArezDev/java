...
//RelogCokis
            ...
            URL url = new URL("https://balanesohib.team/server_akun/api/data.php?get_akun=fb&id=GaweAdd&total=1");
            ...
            //write acc
            try (FileWriter data_cookis = new FileWriter("C:\\Users\\AREZDEV\\Documents\\DATAKODINGJAVA\\akun-" + emulator + ".txt"); BufferedWriter br = new BufferedWriter(data_cookis)) {
    ...
    public static void start(String devices) throws URISyntaxException, InterruptedException {
        ...
        try {
            ...
            BufferedReader bfr;
            bfr = new BufferedReader(new FileReader("C:\\Users\\AREZDEV\\Documents\\DATAKODINGJAVA\\akun-" + devices + ".txt"));
